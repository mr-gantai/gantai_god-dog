...
cowsay -f eyes "MR.GANTAI∅" | lolcat
figlet -f slant "mr.gantai∅" | lolcat
echo "    <=====================[]====================>" | lolcat
echo "    <=====[       Tools By Mr.gantai∅       ]=====>" | lolcat
echo  "    <=====[  Concact Me : +6289630058754  ]=====>" | lolcat
echo "    <=====================[]====================>" | lolcat
...
99) echo "Autor : Mr.gantai" | lolcat
figlet -f slant "mr.gantai" | lolcat
exit
;;
